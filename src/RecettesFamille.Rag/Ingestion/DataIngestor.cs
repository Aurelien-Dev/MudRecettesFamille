...
/// <summary>
/// Orchestrates the ingestion pipeline: detecting changes, generating embeddings, and storing vectors.
/// </summary>
...
{
    /// <summary>
    /// Static helper method to ingest data from a service provider scope.
    /// </summary>
    ...
    /// <summary>
    /// Ingests data from the specified source, updating the vector store as needed.
    /// </summary>
    public async Task IngestDataAsync(IIngestionSource source)
    {
        ...
        logger.LogInformation("Found {count} documents to ingest", modifiedDocs.Count());
