...
namespace RecettesFamille.Data.Migrations
{
    ...
    [Migration("20260808114423_AddAiMetadataToYoutubeSummaries")]
    partial class AddAiMetadataToYoutubeSummaries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecettesFamille.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("PendingApprovalToken")
                        .HasColumnType("text");

                    b.Property<DateTime?>("PendingApprovalTokenExpires")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("RecettesFamille.Data.EntityModel.CategoryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RecettesFamille.Data.EntityModel.TravelEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RecettesFamille.Data.EntityModel.YoutubeResumeEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("AiMetadataAnalyzedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("AiMetadataError")
                        .HasColumnType("text");

                    b.Property<int>("AiMetadataStatus")
                        .HasColumnType("integer");
                    ...
                    b.Property<double?>("MainCountryConfidence")
                        .HasColumnType("double precision");

                    b.Property<string>("MainCountryIsoCode")
                        .HasColumnType("text");

                    b.Property<string>("MainCountryName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("UserFavoriteRecipes", b =>
                {
            ...
            modelBuilder.Entity("YoutubeResumeCategories", b =>
                {
                    b.Property<int>("YoutubeResumeId")
                        .HasColumnType("integer");

                    b.Property<int>("CategoryId")
                        .HasColumnType("integer");

                    b.HasKey("YoutubeResumeId", "CategoryId");

                    b.HasIndex("CategoryId");

                    b.ToTable("YoutubeResumeCategories", (string)null);
                });
            ...
            modelBuilder.Entity("RecettesFamille.Data.EntityModel.Blocks.BlockImageEntity", b =>
                {
                    ...
                    b.ToTable("BlockImageEntity", t =>
                        {
                            t.HasCheckConstraint("CHK_Photo_ImageDataSize", "octet_length(image_data) <= 1048576");
                        });
                });
            ...
            modelBuilder.Entity("RecettesFamille.Data.EntityModel.RecipeEntity", b =>
                {
                    b.HasOne("RecettesFamille.Data.ApplicationUser", "CreatedByUser")
            ...
            modelBuilder.Entity("RecettesFamille.Data.EntityModel.YoutubeResumeEntity", b =>
                {
                    b.HasOne("RecettesFamille.Data.EntityModel.TravelEntity", "Travel")
                        .WithMany("YoutubeSummaries")
            ...
            modelBuilder.Entity("YoutubeResumeCategories", b =>
                {
                    b.HasOne("RecettesFamille.Data.EntityModel.CategoryEntity", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RecettesFamille.Data.EntityModel.YoutubeResumeEntity", null)
                        .WithMany()
